...
pkgdatadir = $(datadir)/carsim
pkgincludedir = $(includedir)/carsim
pkglibdir = $(libdir)/carsim
pkglibexecdir = $(libexecdir)/carsim
...
CarSim_LINK = $(CXXLD) $(CarSim_CXXFLAGS) $(CXXFLAGS) $(AM_LDFLAGS) \
	$(LDFLAGS) -o $@
AM_V_P = $(am__v_P_$(V))
...
am__v_CCLD_1 = 
SOURCES = $(CarSim_SOURCES)
DIST_SOURCES = $(CarSim_SOURCES)
...
ACLOCAL = ${SHELL} /home/wildenberg/CarSim/build-aux/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /home/wildenberg/CarSim/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/wildenberg/CarSim/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/wildenberg/CarSim/build-aux/missing automake-1.14
AWK = gawk
CPPFLAGS = 
CXX = g++
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/wildenberg/CarSim/build-aux/missing makeinfo
MKDIR_P = /usr/bin/mkdir -p
OBJEXT = o
PACKAGE = carsim
PACKAGE_BUGREPORT = ewilden2017@gmail.com
PACKAGE_NAME = CarSim
PACKAGE_STRING = CarSim 0.0.1
PACKAGE_TARNAME = carsim
PACKAGE_URL = 
...
STRIP = 
VERSION = 0.0.1
abs_builddir = /home/wildenberg/CarSim
abs_srcdir = /home/wildenberg/CarSim
abs_top_builddir = /home/wildenberg/CarSim
abs_top_srcdir = /home/wildenberg/CarSim
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /home/wildenberg/CarSim/build-aux/install-sh
...
CarSim$(EXEEXT): $(CarSim_OBJECTS) $(CarSim_DEPENDENCIES) $(EXTRA_CarSim_DEPENDENCIES) 
	@rm -f CarSim$(EXEEXT)
	$(AM_V_CXXLD)$(CarSim_LINK) $(CarSim_OBJECTS) $(CarSim_LDADD) $(LIBS)
